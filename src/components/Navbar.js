    ...
    <nav className={classes.container}>
      ...
      <div className={classes.rightSideContainer}>
        <div>
          ...
          >
            {networks[props.currentNetwork] &&
              <>
                <img src={networks[props.currentNetwork].icon} height="20" width="20" alt="" />
                <span className={classes.netWorkText}>{networks[props.currentNetwork].title}</span>
                <ExpandMoreIcon />
              </>
            }
          </div>
          <Popper
            ...
            transition
            disablePortal
            className={classes.netWorkTopContainer}
